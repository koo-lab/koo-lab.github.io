...
<p>Such pilots would not be cheap in absolute terms, but they would be cheap relative to full-scale infrastructure. In regulatory genomics, a serious scaling pilot might cost hundreds of thousands to a few million dollars, depending on the assay, replication, number of cellular contexts, and sequencing depth. That is the right order of magnitude for deciding whether a data type has a plausible scaling curve before committing tens or hundreds of millions of dollars to build it.</p>
